...
import (
	...
	"g.rg-s.com/sferal/go/entry/types/audio"
	"g.rg-s.com/sferal/go/entry/types/html"
	"g.rg-s.com/sferal/go/entry/types/image"
	"g.rg-s.com/sferal/go/entry/types/text"
	"g.rg-s.com/sferal/go/entry/types/video"
)
